...
if __name__ == "__main__":
    ...
    def discriminant_classification(num_lower_dims, getResultingClassifier = False):
        ...
        (Q,B) = myfac.projrep(Datan, k_or_tol=num_lower_dims)
        ...
        if getResultingClassifier:
            return (dlist, percent_right, total_wrong, total_train)
        else:
    ...
    (dlist, percent_right, total_wrong, total_train) = discriminant_classification(kopt,getResultingClassifier=True)
